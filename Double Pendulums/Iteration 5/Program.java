...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        try {
            String destination = "D:/IIT Roorkee/Miscellaneous/Double Pendulums/Iteration 5/";
                ...
                for (int j = 0; j < width; j++) {
                    for (int k = 0; k < height; k++) {
                        Color newColor = new Color(
                                ColourMatrix[(int) (OmegaMatrix[j][k][0])][(int) (OmegaMatrix[j][k][1])][0],
                                ColourMatrix[(int) (OmegaMatrix[j][k][0])][(int) (OmegaMatrix[j][k][1])][1],
                                ColourMatrix[(int) (OmegaMatrix[j][k][0])][(int) (OmegaMatrix[j][k][1])][2]);
